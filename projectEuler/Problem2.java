...
public class Problem2 {
	...
	public Problem2(int number1, int number2) {
		...
		if (this.sum % 2 == 0) {
			this.sumOfEvens = this.sum;
		}
	}

	public static void printSumOfEvens(Problem2 p2) {
		System.out.printf("The sum of the evens " + "whose sequence values do not exceed %,d was %,d.\n", p2.maxRange,
				p2.sumOfEvens);
	}

	public static void calcSumOfEvens(Problem2 p2) {
		while (p2.number2 < p2.maxRange) {
			System.out.printf("%,d + %,d = %,d, sum of evens is %,d\n", p2.number1, p2.number2, p2.sum, p2.sumOfEvens);
			p2.number1 = p2.number2;
			p2.number2 = p2.sum;
			p2.sum = p2.number1 + p2.number2;
			if (p2.sum % 2 == 0) {
				p2.sumOfEvens += p2.sum;
			}
		}
	}

	public static void main(String[] args) {
		Problem2 p2 = new Problem2(0, 1);
		calcSumOfEvens(p2);
		printSumOfEvens(p2);
	}
