...
public class Dog {
	...
	public static void jumpStatic(Dog dog){   // can be in any class
		System.out.println("I'm jumping...");
	...
	public static void main(String[] args) {
		...
		Dog.jumpStatic(spike);  // call static method
		...
		// show vet
		Dog.getVet().printInfo();
		spike.setSound("bark");
		spike.bark();
		spike.bark(4);
		System.out.println("A dog is of species " + Dog.SPECIES);
	}
